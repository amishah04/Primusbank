...
public class DataDrivenDriverScript {
	...
	String inputpath = "/Users/gauravsalkar/eclipse-workspace/PrimusBank/TestInput//LoginData.xlsx";
	
	String outputpath = "/Users/gauravsalkar/eclipse-workspace/PrimusBank/TestOutput/DataDrivenResults.xlsx";
	...
	public void setUp () throws Throwable, IOException
	{
		...
		config.load(new FileInputStream("/Users/gauravsalkar/eclipse-workspace/PrimusBank/PropertyFile/OR.properties"));
	
		if(config.getProperty("Browser").equalsIgnoreCase("chrome"))
	 {
 		 
		System.setProperty("webdriver.chrome.driver","/Users/gauravsalkar/eclipse-workspace/PrimusBank/CommonDrivers/chromedriver" );
